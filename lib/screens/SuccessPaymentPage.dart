...
class SuccessPaymentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Perhitungan pajak 10% sesuai logika di checkout_dialog
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          // --- SISI KANAN: STRUK (SAMA DENGAN CHECKOUT_DIALOG) ---
          Expanded(
            flex: 4,
            child: Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(orderId, style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF4285F4), fontSize: 18, fontFamily: 'Poppins')),
                    const SizedBox(height: 20),
                    Row(
                    ...
                    // List Menu (Sesuai Layout CheckoutDialog)
                    Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    // DISINI PERBAIKANNYA: Menggunakan unitPrice bukan price
