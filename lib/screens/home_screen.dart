...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // 👇 INI BARIS YANG DITAMBAHKAN AGAR TIDAK ERROR 👇
  ...
  Future<void> _loadInitialData() async {
    try {
      ...
      setState(() {
        ...
        _outletName = results[3] as String;
  ...
  void _handleCheckoutSuccess(Map<String, dynamic> result) {
    ...
    final String currentOutlet = _outletName;
          ...
          setState(() {
            ...
            if (label == "All Menu") {
              ...
              _filteredProducts = _allProducts.where((p) {
                String rawCategory = p.category.toLowerCase();
                return rawCategory.contains(label.toLowerCase());
              }).toList();
            }
          });
        },
