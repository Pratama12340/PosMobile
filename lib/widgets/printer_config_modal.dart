...
class _PrinterConfigModalState extends State<PrinterConfigModal> {
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildModernDropdown(
                        label: "Mode Printer",
                        value: selectedMode,
                        items: ["Standard Printing", "Esc/Pos Mode", "Star Mode"],
                      ...
                      _buildModernTextField("Nama Printer", "Contoh: Kasir Lantai 1"),
                      
                      Row(
                        children: [
                          Expanded(child: _buildModernTextField("Chars. per line", "32")),
                          const SizedBox(width: 20),
                          Expanded(child: _buildModernTextField("Port Printer", "9100")),
                        ],
                      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text("Pengaturan Perangkat", style: AppStyle.menuText.copyWith(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
        ],
      ),
    );
  }

  // --- WIDGET BARU: Toggle Status Aktif ---
  Widget _buildStatusSwitch() {
    return Container(
      ...
      child: SwitchListTile(
        title: Text(
          "Status Perangkat", 
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: isActive ? Colors.green.shade800 : Colors.red.shade800)
        ),
        subtitle: Text(
          isActive ? "Printer aktif dan siap menerima data cetak." : "Printer dinonaktifkan sementara oleh sistem.", 
  ...
  Widget _buildModernDropdown({
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(label, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black54, letterSpacing: 0.5)),
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                onChanged: isActive ? onChanged : null, // Disable dropdown jika printer nonaktif
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              filled: true,
              fillColor: isActive ? Colors.grey.shade50 : Colors.grey.shade200, // Warna berubah jika disable
              ...
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: AppStyle.primaryBlue, width: 2)),
              disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Colors.grey.shade200, width: 1.5)),
            ),
          ),
        ],
      ),
  ...
  Widget _buildNetworkFields() {
    return Column(
      ...
      children: [
        _buildModernTextField("IP Address Printer", "192.168.1.100"),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text("Cari Printer Bluetooth...", style: TextStyle(color: isActive ? Colors.blue : Colors.grey, fontWeight: FontWeight.w600))),
          ElevatedButton(
            onPressed: isActive ? () {} : null, 
            style: ElevatedButton.styleFrom(backgroundColor: Colors.blue, elevation: 0),
            child: const Text("SCAN", style: TextStyle(color: Colors.white, fontSize: 11))
          ),
        ],
      ),
    );
        ...
        children: [
          Expanded(
            child: OutlinedButton(
              ...
              child: const Text("BATALKAN", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, letterSpacing: 1)),
            ),
          ),
          const SizedBox(width: 20),
          Expanded(
            child: ElevatedButton(
              ...
              child: const Text("SIMPAN PERANGKAT", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: 1)),
            ),
          ),
        ],
      ),
